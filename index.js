...
class Seasons {
  ...
  constructor() {
    // ✨ initialize whatever properties are needed
    this.count = 3;
    this.seas = ["summer", "fall", "winter", "spring"];
  }
